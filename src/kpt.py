...
llama = OllamaLLM(model=config.llm_text,format = 'json',temperature=0,base_url=config.port)
...
list_kpt = [ "giá trị phải thu", "nợ phải thu", "khoản phải thu","công nợ","khoảng phải thu"]
def check_kpt(text):
